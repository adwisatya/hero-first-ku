        ...
        <nav class="art-list">
          <ul class="art-list-body">
            ...
            <% } else {
                ...
                List<String> tp_l=Cli.getDeletedPost();
                for(int i=0; i<tp_l.size(); i++) {
                    Post p = Post.JSONtoPost(tp_l.get(i));
                    lp.add(p);
                }
                Collections.sort(lp);
                for(int i=0; i<lp.size(); i++) {
                    ...
                    <li class="art-list-item">
                            ...
                            <p>
                              <a href="handler/admRecov.jsp?id=<% out.println(p.id); %>">Recover</a>
